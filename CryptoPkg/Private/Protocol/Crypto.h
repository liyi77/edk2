...
typedef
VOID *
(EFIAPI *EDKII_CRYPTO_EC_DH_NEW_BY_NID)(
  IN UINTN  Nid
  );
...
typedef
VOID
(EFIAPI *EDKII_CRYPTO_EC_DH_FREE)(
  IN  VOID  *EcContext
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPTO_EC_DH_GENERATE_KEY)(
...
struct _EDKII_CRYPTO_PROTOCOL {
  ...
  EDKII_CRYPTO_EC_DH_NEW_BY_NID                       EcDhNewByNid;
  EDKII_CRYPTO_EC_DH_FREE                             EcDhFree;
  EDKII_CRYPTO_EC_DH_GENERATE_KEY                     EcDhGenerateKey;
