...
{
  CALL_CRYPTO_SERVICE (EcDhNewByNid, (Nid), NULL);
}
...
{
  CALL_VOID_CRYPTO_SERVICE (EcDhFree, (EcContext));
}
...
{
  CALL_CRYPTO_SERVICE (EcDhGenerateKey, (EcContext, PublicKey, PublicKeySize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (EcDhGetPubKey, (EcContext, PublicKey, PublicKeySize), FALSE);
}
