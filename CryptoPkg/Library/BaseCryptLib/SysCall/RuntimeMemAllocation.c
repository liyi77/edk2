...
//
// Increase memory pool size to reduce fragmentation for ML-DSA operations
// Original: 1100 blocks (1.1 MB)
// New: 2048 blocks (2 MB) - provides more headroom for large keys
//
#define MIN_REQUIRED_BLOCKS  2048
